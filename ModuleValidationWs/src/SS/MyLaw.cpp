...
MyLaw::MyLaw() {
    ...
    controlFilePath = std::string(SOURCE_DIR) + "/src/SS/SimData/ControlData.csv";
...
void MyLaw::CalculateControl(const Eigen::MatrixXf& stateM, float dt) {
    ...
    Eigen::Vector3f w_estimation_rot = Observer::StateSpace::EstimateDisturbanceUDE_rot(q, omega, dt);
