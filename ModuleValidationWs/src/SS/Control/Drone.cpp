...
Drone::Drone(float mass, const Eigen::Matrix3f& J_inertia, float timestep)
    ...
    this->mass = mass;
    this->J = J_inertia;
    transDistrubance = Eigen::Vector3f(0, 0, 0);
    Fu = 0;
    ...
    transFilePath = TRANSLATION_FILE_PATH_CSV;
    rotFilePath = ROTATION_FILE_PATH_CSV;
...
void Drone::updateState() {
    ...
    ddp = Eigen::Vector3f(rotated_force.x(), rotated_force.y(), rotated_force.z()) + transDistrubance;
