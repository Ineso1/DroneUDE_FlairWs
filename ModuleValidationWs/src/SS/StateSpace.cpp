...
StateSpace::StateSpace() {
    ...
    hatTransFilePath = std::string(SOURCE_DIR) + "/src/SS/SimData/TranslationalEstimation.csv";
    hatRotFilePath = std::string(SOURCE_DIR) + "/src/SS/SimData/RotationalEstimation.csv";
